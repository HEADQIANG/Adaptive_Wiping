"""Measured sensor wrench contract; robot poses remain in SDK coordinates."""
...
FRAME_KEYS = ("sensor_to_ft_frame", "sensor_bias_si")
VERIFICATIONS = (
...
def calibration_issues(record):
    ...
    expected = {
        "schema_version": 2,
        "artifact_kind": "airbot_sensor_calibration",
        "source_kind": "real",
    }
...
class Calibration:
    ...
    def metadata(self):
        fields = ("robot_id", "sensor_id", "calibration_id", "sensor_frame")
        return {
            **CONVENTIONS,
